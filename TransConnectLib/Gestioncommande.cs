    ...
    public class GestionCommande
{
    ...
    public void CreerCommande()
    {
        ...
        Client client = new Client(numSecu, nom, prenom, dateNaissance, adressePostale, adresseMail, telephone, clientId);
        ...
        Chauffeur chauffeur = Salarie.EmployeTC.Find(c => c.NumSecu == chauffeurNumSecu) as Chauffeur;
        if (chauffeur == null)
        {
